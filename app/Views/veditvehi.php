...
<style>
    ...
    <div class="card">
        ...
        <div class="card-body">
          ...
          <form  action="<?php echo site_url('/updatevehi')?>" method="post">
                <div class="row">
                    <div class="form-group col-md-6 col-sm-12">
                        <label for="Nombre" class="form-control-label">placa</label>
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                        <label for="text" class="form-label">fecha de entrada</label>
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                        <label for="text" class="form-label">hora de entrada</label>
